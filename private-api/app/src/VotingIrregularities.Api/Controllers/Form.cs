...
namespace VotingIrregularities.Api.Controllers
{
    ...
    public class Form : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet("versiune")]
        public async Task<IEnumerable<VersionModel>> Versiune()
        {
            return await _mediator.Send(new FormModel.VersionQuery());
        }
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<IEnumerable<SectionModel>> GetFormById(Guid formId)
        {
