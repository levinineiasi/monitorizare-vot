...
namespace VotingIrregularities.Api.Queries
{
    public class FormQueryHandler :
        IAsyncRequestHandler<FormModel.VersionQuery,IEnumerable<VersionModel>>,
        IAsyncRequestHandler<FormModel.QuestionsQuery,IEnumerable<SectionModel>>
    {
        ...
        public async Task<IEnumerable<VersionModel>> Handle(FormModel.VersionQuery message)
        {
            ...
            return result
                .Where(v => v.AvailabilityDate.Date == DateTime.Today)
                .OrderBy(v => v.Order)
                .Select(i => new VersionModel
            {
                Id = i.FormCode,
